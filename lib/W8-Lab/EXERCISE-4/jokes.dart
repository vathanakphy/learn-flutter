class Joke {
  static int favouriteIndex = -1;
  static List<Joke> jokeList = [];
...
// Create jokes (each one auto-adds itself to jokeList)
void loadJokes() {
  Joke(
  ...
  Joke(
    ...
    description: "I told my computer I needed a break, and it said 'No problem – I'll go to sleep.'",
  );
  Joke(
  ...
  Joke(
    title: "Silent P",
    description: "Why can’t you hear a pterodactyl go to the bathroom? Because the 'P' is silent.",
  );
  Joke(
    title: "Moon Restaurant",
    description: "Did you hear about the restaurant on the moon? Great food, no atmosphere.",
  );
  Joke(
    title: "Mugged Coffee",
  ...
  Joke(
    ...
    description: "I asked the librarian if books about paranoia were available. She whispered, 'They're right behind you…'",
  );
  Joke(
  ...
  Joke(
    title: "Golf Pants",
    description: "Why did the golfer bring two pairs of pants? In case he got a hole in one.",
  );
  Joke(
    title: "Roof Joke",
